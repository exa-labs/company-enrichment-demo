  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHeader
        ...
        rightContent={<HowItWorksHeaderButtons llmContent={LLM_CONTENT} />}
      />
            ...
            <StepContainer>
              <Step number={1} title="Query your company records">
                <p className="mb-4">
                  ...
                  along with the record IDs for syncing data back. This example uses Salesforce, but works with any database.
                </p>
                <CodeBlock
                  language="javascript"
  ...
  return { data: response.answer, sources: response.citations };
              ...
              <Step number={3} title="Update your database with enriched data">
                ...
                <CodeBlock
                  ...
                  code={`async function updateSalesforceAccount(accountId, enrichedData) {
  await salesforce.sobjects.Account.update({
    Id: accountId,
...
for (const account of accounts) {
  ...
  await updateSalesforceAccount(account.id, data);
}`}
                />
                <div className="mt-4">
  ...
  // Refresh logic here
              ...
              <Step number={2} title="Query accounts prioritized by staleness">
                ...
                <CodeBlock
                  ...
                  code={`const accounts = await salesforce.query(
  ...
  // data contains fresh structured company info
              ...
              <Step number={4} title="Push updates to your database" isLast>
                ...
                <CodeBlock
                  ...
                  code={`await updateSalesforceAccount(account.Id, data);`}
                />
                <div className="mt-4">
  ...
  // New account enrichment logic here
              ...
              <Step number={2} title="Query new records">
                ...
                <CodeBlock
                  ...
                  code={`const newAccounts = await salesforce.query(
...
app.post('/webhook/new-account', async (req, res) => {
  ...
  await updateSalesforceAccount(req.body.id, data);
});`}
                />
                <div className="mt-4">
